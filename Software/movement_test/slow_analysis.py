...
encoder_filename = "Pos_encoder_slow"
dataset_filename = "Pos_ITLS_SLI_move_slow"
save_plot_name = "Erro 3D slow"
anchors_coordinates_filename = "anchor_coordinates"
starting_coordinate = [6757, 2346, 884]
ending_coordinate = [12093, 2382, 890]
