...
filename = "128_nlos_pos1" # filename containing the dataset to load
...
save_datafolder = "position1\\plots" # folder path to save the generated data
saving_filename = "Erro Distância Teste 2" # filename to save the generated data
